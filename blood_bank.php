...
<body id="body">
  ...
  <div class="container col-12 text-center" style="background-image: url(img/04bc14f6-8142-486c-85de-6a25808ef789.jpg); background-repeat: no-repeat; background-attachment: fixed; background-size: cover; margin-top: 100px;">
    <div class="intro">
      <h1>Blood Bank</h1>
    ...
    <section id="services" class="text-center p-3 m-3">
        <div class="row row-cols-1 row-cols-md-4 g-4 m-2">
            <div class="col">
                 <div class="card">
                    <a href="a+.php"><img src="img/A+.png" class="card-img-top img" alt="A+"></a>
                 </div>
            </div>
            <div class="col">
                 <div class="card">
                    <a href="b+.php"><img src="img/B+.png" class="card-img-top img" alt="B+"></a>
                 </div>
            </div>
            <div class="col">
                 <div class="card">
                    <a href="ab+.php"><img src="img/AB+.png" class="card-img-top img" alt="AB+"></a>
                 </div>
            </div>
            <div class="col">
                 <div class="card">
                    <a href="o+.php"><img src="img/O+.png" class="card-img-top img" alt="O+"></a>
                 </div>
            </div>           
        </div>
        <div class="row row-cols-1 row-cols-md-4 g-4 m-2">
