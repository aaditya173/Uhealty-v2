                        ...
                        <div class="owl-stage">
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        ...
                                        <div class="img-box">
                                            <img src="https://aiimsrishikesh.edu.in/images/doctor_image/AnaesthesiologyDrDebendraKumarTripathi.jpg" alt="Dr. Debendra Kumar Tripathi">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6 class="text-center">Dr. Debendra Kumar Tripathi</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        ...
                                        <div class="img-box">
                                            <img src="https://aiimsrishikesh.edu.in/images/doctor_image/AnaesthesiologyDrGauravJain.jpg" alt="Dr. Gaurav Jain">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>Dr. Gaurav Jain</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        ...
                                        <div class="img-box">
                                            <img src="https://aiimsrishikesh.edu.in/images/doctor_image/AnaesthesiologyDrAjiKumar.jpg" alt="Dr. Ajit Kumar"></div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>Dr. Ajit Kumar</h6>
                                            </div>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        <div class="btn_container">
                                            <a href="aarogyam_hospital.html">Book Appoinment</a>
                                        </div>
                                        <div class="img-box">
                                            <img src="https://aiimsrishikesh.edu.in/images/doctor_image/AnatomyDrMukeshSingla.jpg" alt="Dr. Mukesh Singla">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>Dr. Mukesh Singla</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
