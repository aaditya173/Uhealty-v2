...
<body>
    ...
    <section class="health_section layout_padding">
        <div class="health_carousel-container">
            <h2 class="text-uppercase text-center">Hospitals</h2>
                        ...
                        <div class="owl-stage">
                                ...
                                <div class="item">
                                    <div class="box">
                                        <div class="btn_container">
                                            <a href="aiims-rishikesh.php">Explore</a>
                                        </div>
                                        <div class="img-box">
                                            <img src="img/aiims-rishikesh.jpg" alt="AIIMS-RISHIKSEH">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6 class="text-center">AIIMS-RISHIKSEH</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        <div class="btn_container">
                                            <a href="core_hospital.php">Explore</a>
                                        </div>
                                        <div class="img-box">
                                            <img src="img/core_hospital.jpg" alt="CORE HOSPITAL">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>CORE HOSPITAL</h6>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        <div class="btn_container">
                                            <a href="bhumanand_hospital.php">Explore</a>
                                        </div>
                                        <div class="img-box">
                                            <img src="img/bhumanand_hospital.jpeg" alt="Bhumanand Hospital">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>Bhumanand Hospital</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="owl-item active mx-auto" style="width: 420.673px; margin-right: 10px;">
                                <div class="item">
                                    <div class="box">
                                        <div class="btn_container">
                                            <a href="aarogyam_hospital.php">Explore</a>
                                        </div>
                                        <div class="img-box">
                                            <img src="img/aarogyam_hospital.jpeg" alt="website template image">
                                        </div>
                                        <div class="detail-box">
                                            <div class="text">
                                                <h6>Aarogyam Hospital</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
